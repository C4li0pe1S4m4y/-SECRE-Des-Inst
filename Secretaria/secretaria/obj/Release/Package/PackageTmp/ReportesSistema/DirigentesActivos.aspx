<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DirigentesActivos.aspx.cs" Inherits="secretaria.ReportesSistema.DirigentesActivos" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <br />
    <h2>Listado de Dirigentes Activos</h2>
    <div class="panel-default">
        ...
        <%--<div class="row">
            <div style="width: 100%; height: 100%;">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:dbsecretariaConnectionString %>" ProviderName="<%$ ConnectionStrings:dbsecretariaConnectionString.ProviderName %>" SelectCommand="SELECT f.nombre, d.Nombres, d.Apellidos AS Nombres, d.Estado, t.descripcion, c.Fecha_inicio, c.Fecha_final, c.Acuerdo_cej, c.Fecha_acuerdo, c.Acreditacion_cdag, c.Fecha_Acreditacion, c.no_finiquito, c.fecha_finiquito, c.acta_posesion, c.fecha_posesion, c.fecha_recepcion, d.DPI, d.NIT FROM sg_comite_ejecutivo c INNER JOIN sg_dirigente d ON c.id_dirigente = d.idDirigente INNER JOIN sg_fadn f ON f.id_fand = c.id_fadn INNER JOIN sg_tipo_dirigente t ON t.idTipo_dirigente = d.Tipo_dirigente WHERE (c.Estado_Comite = 1) ORDER BY f.nombre, d.Tipo_dirigente"></asp:SqlDataSource>
            </div>
