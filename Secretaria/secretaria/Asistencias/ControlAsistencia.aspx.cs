            ...
            switch (estadoAsamblea)
            {
                case 1:
                    if (contAsistencia.TotalFederados(nom) < necQuorum)
                    {
                        ...
                        lblEstadoAsamblea2.Text = "Aún no se ha reunido el mínimo para iniciar el Quórum."; lblEstadoAsamblea2.DataBind();
                    ...
                    else
                    {
                        ...
                        lblEstadoAsamblea2.Text = "Ya es posible realizarse el Quórum."; lblEstadoAsamblea2.DataBind();
                ...
                case 2:
                    ...
                    lblEstadoAsamblea2.Text = "El Quórum se ha iniciado."; lblEstadoAsamblea2.DataBind();
                ...
                case 4:
                    ...
                    btIniciarQuorumF.Visible = false; btIniciarQuorumF.DataBind();
                    btFinalizarQuorum2.Visible = false; btFinalizarQuorum2.DataBind();
                    lblEstadoAsamblea2.Text = "El Quórum se ha terminado."; lblEstadoAsamblea2.DataBind();
                    lblHora.Text = modelAsamblea.final; lblHora.DataBind();
                    btReporte.Visible = true; btReporte.DataBind();
                    lblA.Visible = false;
                    lblTA.Visible = false;
